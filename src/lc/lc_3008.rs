...
mod tests {
    ...
    fn test_beautiful_indices() {
        assert_eq!(
            Solution::beautiful_indices("xxtxxuftxt".to_string(), "tx".to_string(), "x".to_string(), 2),
            [2, 7]
        );
        assert_eq!(
            Solution::beautiful_indices("vatevavakz".to_string(), "va".to_string(), "lbda".to_string(), 1),
            []
        );
        assert_eq!(
