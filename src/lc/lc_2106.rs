...
mod tests {
    ...
    fn max_total_fruits() {
        assert_eq!(
            Solution::max_total_fruits(vec_vec![[2, 8], [6, 3], [8, 6]], 5, 4),
            9
        );
        assert_eq!(
            Solution::max_total_fruits(
                vec_vec![[0, 9], [4, 1], [5, 7], [6, 2], [7, 4], [10, 9]],
                5,
                4
            ),
            14
        ...
        assert_eq!(
            Solution::max_total_fruits(vec_vec![[0, 3], [6, 4], [8, 5]], 3, 2),
            0
        );
    }
}
